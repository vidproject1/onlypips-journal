          ...
          {loading ? (
            ...
            <div className="grid gap-4">
              {checklists.map((checklist) => {
                ...
                const isFree = checklist.price === 0 || checklist.price == null;
                  ...
                  <Card key={checklist.id} className="w-full">
                    ...
                    <CardContent>
                      <div className="flex flex-wrap gap-2">
                        ...
                        {(purchased || isFree) && (
                          <InstructionsDialog marketplaceChecklistId={checklist.id} />
                        )}
                        {purchased ? (
                          <Button
                            variant="outline"
        ...
        <DialogContent className="max-w-2xl">
          ...
          {selectedChecklist && bankDetails && (
            <div className="space-y-6">
              <div className="bg-blue-50 p-4 rounded-lg text-black dark:text-black">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg text-black dark:text-black">
